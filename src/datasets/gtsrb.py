...
class GTSRB:
    def __init__(self,
        ...
        #     print('gtsrb subset_data_ratio:' + str(subset_data_ratio))
        #     print('gtsrb random_indexs:' + str(random_indexs))
        ...
        if subset_data_ratio < 1.0:
            ...
            print('gtsrb subset_data_ratio:' + str(subset_data_ratio))
            print('gtsrb test_dataset_len:' + str(len(self.test_dataset)))
            print('gtsrb random_indexs:' + str(random_indexs)[:50])
