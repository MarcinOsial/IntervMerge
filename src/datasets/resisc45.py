...
class RESISC45:
    def __init__(self,
        ...
        #     print('RESISC45 subset_data_ratio:' + str(subset_data_ratio))
        #     print('RESISC45 random_indexs:' + str(random_indexs))
        ...
        if subset_data_ratio < 1.0:
            ...
            print('resisc45 subset_data_ratio:' + str(subset_data_ratio))
            print('resisc45 test_dataset_len:' + str(len(self.test_dataset)))
            print('resisc45 random_indexs:' + str(random_indexs)[:50])
